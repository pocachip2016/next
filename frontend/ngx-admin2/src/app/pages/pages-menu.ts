...
export const MENU_ITEMS: NbMenuItem[] = [
  ...
  {
    title: 'Pricemon Dashboard',
    icon: 'grid-outline',
    children: [
      {
        title: 'Contents Panel',
        link: '/pages/pricemon/content-panel'
      },
      {
        title: 'Price Panel',
        link: '/pages/pricemon/price-panel'
      },
      {
        title: 'Product Panel',
        link: '/pages/pricemon/product-panel'
      },
    ]
  },
  {
    title: 'RightWatch Dashboard',
    icon: 'grid-outline',
    children: [
      {
        title: 'Contents Panel',
      ...
      {
        title: 'Check List',
        link: '/pages/rightwatch/check-list',
      },
      {
        title: 'Check List Detail',
        link: '/pages/rightwatch/check-list-detail',
      },
      {
        title: 'Post List',
